...
function UserUpdate() {
    ...
    const handleUpdate = (e) => {
        ...
        fetch(`http://sneakverse.it/api/users/${id}`, {
            method: "PUT",
            headers: {
    ...
    return (
        <div className="form-container">
            ...
            <form onSubmit={handleUpdate} className="admin-form">
                <input type="text" placeholder="Nuovo Nome" onChange={e => setFormData({ ...formData, firstName: e.target.value })} />
                <input type="text" placeholder="Nuovo Cognome" onChange={e => setFormData({ ...formData, lastName: e.target.value })} />
                <input type="text" placeholder="Nuova Email" onChange={e => setFormData({ ...formData, email: e.target.value })} />
