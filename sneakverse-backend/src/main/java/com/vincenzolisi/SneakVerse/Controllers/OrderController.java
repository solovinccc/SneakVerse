...
public class OrderController {
    ...
    public String checkout(@RequestBody CheckoutRequestDTO req) {
        return service.checkout(req);
    }


    @GetMapping("/user/{userId}")
    public List<OrderViewDTO> getUserActiveOrders(@PathVariable int userId) {
        return service.getActiveOrderByUser(userId);
    }

    @PutMapping("/{orderId}/deliver")
    public String confirmDelivery(@PathVariable int orderId) {
        return service.confirmDelivery(orderId);
    }
