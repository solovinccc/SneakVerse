...
@Generated("")
@OpenAPIDefinition(
	info = @Info(description = "SneakverseAuth REST API - Modulo per la gestione della sessione", license = @License(name = "Apache 2.0", url = "http://www.apache.org/licenses/LICENSE-2.0.html"), title = "SneakverseAuth", version = "v1.0")
)
@Path("/v1.0")
