 ...
 */
@Generated("")
@GraphQLName("LoginRequest")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "LoginRequest")
public class LoginRequest implements Serializable {

	public static LoginRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(LoginRequest.class, json);
	}

	public static LoginRequest unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(LoginRequest.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.vincenzolisi.sneakverse.headless.auth.dto.v1_0.LoginRequest",
		name = "x-class-name"
	)
