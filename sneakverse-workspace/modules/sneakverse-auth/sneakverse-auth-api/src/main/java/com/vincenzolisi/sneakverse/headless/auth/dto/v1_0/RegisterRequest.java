 ...
 */
@Generated("")
@GraphQLName("RegisterRequest")
@JsonFilter("Liferay.Vulcan")
@XmlRootElement(name = "RegisterRequest")
public class RegisterRequest implements Serializable {

	public static RegisterRequest toDTO(String json) {
		return ObjectMapperUtil.readValue(RegisterRequest.class, json);
	}

	public static RegisterRequest unsafeToDTO(String json) {
		return ObjectMapperUtil.unsafeReadValue(RegisterRequest.class, json);
	}
	...
	@io.swagger.v3.oas.annotations.media.Schema(
		...
		defaultValue = "com.vincenzolisi.sneakverse.headless.auth.dto.v1_0.RegisterRequest",
		name = "x-class-name"
	)
